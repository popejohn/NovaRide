...
const ClickToReveal = ({ distance, duration, fare, cancelRide }) => {
  ...
  const { checkBalanceAndPay, isProcessing } = useRidePayment(fare, pickupLocation, destination, pickupCoordinate, destinationCoordinate);
