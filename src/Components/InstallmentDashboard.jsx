    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="relative">
          <div className="w-16 h-16 rounded-3xl border-4 border-neutral-200 animate-pulse" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <aside className="lg:col-span-3 space-y-6">
            <motion.div 
              ...
              className="bg-white p-6 rounded-[2rem] border border-neutral-200 shadow-lg relative overflow-hidden"
            >
              <div className="relative z-10">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-neutral-500 mb-4">Maruwa Partner Profile</p>
                <div className="flex items-center gap-4">
                  <div className="w-16 h-16 rounded-[1.5rem] bg-neutral-100 flex items-center justify-center text-neutral-900 text-2xl font-black overflow-hidden border-2 border-neutral-200 shadow-lg">
          ...
          <main className="lg:col-span-9">
            {!installmentData ? (
              <motion.div 
                ...
                className="bg-white p-16 rounded-[3rem] border border-neutral-200 shadow-lg text-center"
              >
                ...
                <h3 className="text-2xl font-black text-neutral-900 mb-2 tracking-tight">Complete Your Maruwa Profile</h3>
                <p className="text-neutral-500 font-bold max-w-sm mx-auto leading-relaxed mb-8 text-xs">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
                      {[
                        ...
                        <div key={i} className="p-6 bg-white rounded-[2rem] border border-neutral-200 shadow-md group hover:border-orange-500/40 hover:shadow-orange-500/5 hover:shadow-lg transition-all duration-300">
