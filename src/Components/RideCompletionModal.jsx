...
const RideCompletionModal = ({ showCompletionModal, setShowCompletionModal, isPassenger, updateRideStatus }) => {
  if (!showCompletionModal || !isPassenger) return null;
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-black uppercase italic tracking-tighter mb-4">
              Ride <span className="text-orange-500">Completed?</span>
            </h2>
            <p className="text-neutral-400 text-sm font-medium leading-relaxed">
              The rider has indicated that you have reached your destination. Please confirm to finalize the transaction.
            </p>
          </div>
